            ...
            <div className={`${BEM_BLOCK}__company-address`}>
              <div className={`${BEM_BLOCK}__street-address--wrapper`}>
                ...
                <input
                  ...
                  onBlur={e => {
                    onToggleCompanyStreetAddressState(e);
                    updateInvoice({ companyStreetAddress: e.target.value });
                  }}
              ...
              <div className={`${BEM_BLOCK}__city-state--wrapper`}>
                <div className={`${BEM_BLOCK}__company-city-state`}>
                  ...
                  <input
                    ...
                    placeholder='City'
                    onBlur={e => {
                      onToggleCompanyCityState(e);
                      updateInvoice({ companyCity: e.target.value });
                    }}
                  ...
                  <input
                    ...
                    placeholder='State'
                    onBlur={e => {
                      onToggleCompanyStateState(e);
                      updateInvoice({ companyState: e.target.value });
                    }}
              ...
              <div className={`${BEM_BLOCK}__zip-code--wrapper`}>
                ...
                <input
                  ...
                  onBlur={e => {
                    onToggleCompanyZipCodeState(e);
                    updateInvoice({ companyZipCode: e.target.value });
                  }}
              ...
              <div className={`${BEM_BLOCK}__country--wrapper`}>
                ...
                <input
                  ...
                  placeholder='Country'
                  onBlur={e => {
                    onToggleCompanyCountryState(e);
                    updateInvoice({ companyCountry: e.target.value });
                  }}
          ...
          <div className={`${BEM_BLOCK}__billed-to`}>
            ...
            <div className={`${BEM_BLOCK}__client-name`}>
              ...
              <input
                ...
                placeholder='First Name'
                onBlur={e => {
                  onToggleClientFirstNameState(e);
                  updateInvoice({ clientFirstName: e.target.value });
                }}
