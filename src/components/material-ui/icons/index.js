...
export const EMAIL_OUTLINE_ICON = (
  <MailOutlineIcon />
);

export const ALTERNATE_EMAIL_OUTLINE_ICON = (
  <AlternateEmailIcon />
);
...
export const PERSON_OUTLINE_ICON = (
  <PersonOutlineIcon />
);
...
export const TODAY_CALENDAR_ICON = (
  <TodayIcon />
);
...
export const ARROW_BACK_IOS_ICON = (
  <ArrowBackIosIcon />
);

export const KEYBOARD_ARROW_RIGHT_ICON = (
  <KeyboardArrowRightIcon />
);

export const HOTEL_BED_ICON = (
  <HotelIcon />
);

export const COMMUTE_ICON = (
  <CommuteIcon />
);
