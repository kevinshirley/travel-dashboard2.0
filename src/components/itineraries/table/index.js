...
function createItineraryData(avatar, name, destination, date, id) {
  return { avatar, name, destination, date, id };
}
...
const headCells = [
  ...
  { id: 'name', numeric: false, disablePadding: true, label: 'Trip Title' },
                  ...
                  return (
                    ...
                    >
                      <TableCell align="right">
                        <Link href={`/manage-itinerary?id=${row.id}`} className='trip-cover'>
                          <Avatar>
                      ...
                      <TableCell component="th" id={labelId} scope="row" padding="none">
                        <Link href={`/manage-itinerary?id=${row.id}`}>{row.name}</Link>
                      </TableCell>
                      <TableCell align="right">{row.destination}</TableCell>
                      <TableCell align="right">{moment.utc(row.date).format('LL')}</TableCell>
                      <TableCell align="right">
                        <Checkbox
